...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title,
    description: `This team spends $${audit.totalMonthlySpend.toLocaleString()}/mo on AI tools. SpendLens found $${savings.toLocaleString()}/mo ($${audit.totalAnnualSavings.toLocaleString()}/yr) in savings.`,
    openGraph: {
      title,
...
export default async function AuditPage({ params }: Props) {
  ...
  return <AuditResultsClient audit={audit} auditId={id} />;
}
